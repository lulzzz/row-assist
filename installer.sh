#!/bin/sh
# WARNING: this script MUST be run as super users
# For more information, see http://www.phidgets.com/docs/OS_-_Linux
...
# Phidgets
apt-get install libusb-1.0-0-dev automake -y -q
